                    ...
                    <div class="w-full">
                        ...
                        <form class="user" method="POST" action="<?= base_url('auth'); ?>">
                            <label class="block text-sm">
                                ...
                                <input id="email" name="email" class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" placeholder="Jane Doe" autocomplete="off" required/>
                            </label>
                            <label class="block mt-4 text-sm">
                                <span class="text-gray-700">Password</span>
                                <input id="password" name="password" class="block w-full mt-1 text-sm focus:border-purple-400 focus:outline-none focus:shadow-outline-purple form-input" placeholder="***************" type="password" required/>
                            </label>

                            <button type="submit" class="block w-full px-4 py-2 mt-4 text-sm font-medium leading-5 text-center text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple" href="index.php">
                                Log in
                            </button>
                        </form>
                        ...
                        <div class="flex justify-between items-center">
                            <p class="mt-4">
                                <a class="text-sm font-medium text-purple-600 hover:underline" href="dashboard">
                                    Kembali
                                </a>
                            </p>
                            <p class="mt-1">
                                <a class="text-sm font-medium text-purple-600 hover:underline" href="<?= base_url('auth/register') ?>">
                                    Buat Akun
                                </a>
                            </p>
                        </div>
